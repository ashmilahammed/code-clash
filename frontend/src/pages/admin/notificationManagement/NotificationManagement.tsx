      ...
      <div className="flex items-center gap-4 mb-8">
        <div className="flex bg-slate-900 p-1 rounded-lg">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-md transition ${activeTab === "compose" ? "bg-blue-600 text-white" : "hover:bg-slate-800"
              }`}
          >
            <Send size={18} />
            Compose
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-md transition ${activeTab === "history" ? "bg-blue-600 text-white" : "hover:bg-slate-800"
              }`}
          >
            <History size={18} />
            History
