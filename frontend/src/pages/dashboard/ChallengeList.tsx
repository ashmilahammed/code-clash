...
//         <div
//           key={challenge.id}
//           className="p-4 rounded-lg bg-[#0F172A] hover:bg-[#020617] transition border border-slate-800"
//         >
//           <div className="flex items-center justify-between mb-1">
//             <h3 className="font-medium text-white">
//               {challenge.title}
...
//             <button
//               disabled
//               className="px-3 py-1 rounded bg-slate-700 text-slate-300 cursor-not-allowed"
//             >
//               Solve (soon)
//             </button>
//           </div>
